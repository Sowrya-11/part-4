...
function gotPoses(results) {
  if (results.length > 0) {
    ...
    scorerietwrist = result[0].pose.keypoints[10].score;

    rietwristX = results[0].pose.rightWrist.x;

    rietwristY = results[0].pose.rightWrist.y;
...
function draw() {
  if (scoreRightWrist > 0.2){
    fill(0, 255, 208);
    stroke(255, 168, 168);
    circle(rietwristX, rietwristY, 5);
  }
